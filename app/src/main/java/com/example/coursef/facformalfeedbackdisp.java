...
public class facformalfeedbackdisp extends AppCompatActivity {
 ...
 public int hk=facformalfeedback.hk;
    ...
    public void sendRequest(){
        if(hk==0){
         request_url = "http://c0dd3a1f.ngrok.io/api/getfeedback?ques="+"q1"+"&coursename="+courses;}
        else if(hk==1){
            request_url = "http://c0dd3a1f.ngrok.io/api/getfeedback?ques="+"q2"+"&coursename="+courses;
        }
        else if(hk==2){
            request_url = "http://c0dd3a1f.ngrok.io/api/getfeedback?ques="+"q3"+"&coursename="+courses;
        }
